...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.pandaemon/workspace"
...
class Config(BaseSettings):
    """Root configuration for pandaemon."""
    ...
    def _match_provider(
        ...
        from pandaemon.providers.registry import PROVIDERS
    ...
    def get_api_base(self, model: str | None = None) -> str | None:
        ...
        from pandaemon.providers.registry import find_by_name
    ...
    model_config = ConfigDict(env_prefix="PANDAEMON_", env_nested_delimiter="__")
