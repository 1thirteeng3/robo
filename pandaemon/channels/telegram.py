...
from pandaemon.config.paths import get_media_dir
from pandaemon.config.schema import TelegramConfig
from pandaemon.utils.helpers import split_message
...
class TelegramChannel(BaseChannel):
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm pandaemon.\n\n"
        ...
        if media_file and self._app:
            try:
                ...
                if media_type == "voice" or media_type == "audio":
                    from pandaemon.providers.transcription import GroqTranscriptionProvider
