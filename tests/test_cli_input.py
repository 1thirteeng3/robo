...
from pandaemon.cli import commands
...
def mock_prompt_session():
    ...
    with patch("pandaemon.cli.commands._PROMPT_SESSION", mock_session), \
         patch("pandaemon.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("pandaemon.cli.commands.PromptSession") as MockSession, \
         patch("pandaemon.cli.commands.FileHistory") as MockHistory, \
